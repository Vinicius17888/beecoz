...
export default function FinalizadoCliente(){
  ...
  return (
    <View style={s.c}>
      ...
      <Text style={s.txt}>
        Os dados apresentados estão em análise. Quando finalizarmos, enviaremos uma mensagem ao e-mail informado no cadastro.
      </Text>
...
const s = StyleSheet.create({
  c:{flex:1,backgroundColor:theme.bg,alignItems:"center",justifyContent:"center",padding:16},
